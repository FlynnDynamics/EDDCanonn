...
namespace EDDTK.Maths
{
	...
	public class Grid
	{
		...
		/// </summary>
		/// <returns></returns>
		/// <remarks>BoundingBox is recomputed each time the function is called, in contrary to eddtk where it is kept in a dangerous cache.</remarks>
