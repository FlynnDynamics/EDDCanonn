...
using EDDTK.Colors;
using EDDTK.Plot2D.Primitive;
using EDDTK.Plot3D.Primitives;
using EDDTK.Plot3D.Primitives.Axes.Layout;
using EDDTK.Plot3D.Primitives.Axes.Layout.Providers;
using EDDTK.Plot3D.Primitives.Axes.Layout.Renderers;
using EDDTK.Plot3D.Rendering.Legends;

namespace EDDTK.Plot3D.Rendering.Legends.Colorbars
{
